 ...
 * 데이터베이스 내부에 정의되어있는 SP_INSERT_CUSTOMER를 호출한다.
 * @author PC38208
 *
 */
public class CustomerSpTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// IN MODE 변수 세팅
			cstmt.setString(1, "전현찬");
			cstmt.setString(2, "덕명동");
			cstmt.setString(3, "010-3901-5250");
			// OUT MODE 변수 세팅
			cstmt.registerOutParameter(4, VARCHAR);
			
			// 4. 쿼리 실행
			System.out.println("저장 프로시저 : SP_INSERT_CUSTOMER 실행 중");
			cstmt.execute();
