package school;
/**
 * 학교 구성원들인 학생, 직원, 교사의 출결, 수업 기능을 테스트하는 클래스
 * @author PC38208
 *
 */
public class SchoolTest {
	...
	public static void main(String[] args) {
		...
		attends[2] = new Employee ("E001", "행랑아범", 50, "행랑채");
		...
		for (Attendance attendance : attends) {
			...
			// Employee는 Lesson타입이 아니므로 형 검사를 한다.
			if (attendance instanceof Lesson) {
				// Student, Teacher는 Lesson 인터페이스도 구현하므로, if 조건을 통과하여 lesson() 기능도 사용할 수 있다.
				System.out.println(((Lesson)attendance).lesson());
			}
			System.out.println("====================================");
		}
	}
