...
public class KeyboardInput2 {
	...
	public static void main(String[] args) {
		...
		// 3. 2의 필터 스트림을 편리한 사용을 위해 한 번 더 포장할 필터 스트림
		BufferedReader br = new BufferedReader(ir);
		
		System.out.println("값을 입력하세요... (ctrl + z 입력시 중단)");
		
		// 4. 3의 필터 스트림의 메소드를 사용하여 키보드 입력을 읽어들인다.
		...
		try {
			...
			// 6. 자원 해제 : 예외발생 여부와 관계없이 항상 안정적으로 해제가 이루어져야 하므로 finally에서
			try {
				if (br != null)
					br.close();
			} catch (IOException e) {
